...
export default function FormNewUser({ open, onClose, onCreate, onEdit, userToEdit = null, companies = [], stores = [] }) {
    ...
    const handleSubmit = (e) => {
        ...
        const userData = {
            ...
            rut: form.rut,
            role: form.role,
            company_id: form.role === 'admin' ? Number(form.company_id) : undefined,
